...
class LoginViewController: UIViewController {
    ...
    private func didTapEyeButton(){
        ...
        if let rightViewContainer = passwordTextField.rightView {
            for subview in rightViewContainer.subviews {
                if let button = subview as? UIButton, button.currentImage == UIImage(named: "eye-slash2") || button.currentImage == UIImage(named: "eye2") {
